...
- **CDN - ES6:**
```
<script src="//npmcdn.com/resizable-drawer@1.0.0-beta.10/dist/resizable-drawer.js"></script>
<link rel="stylesheet" type="text/css" src="//npmcdn.com/resizable-drawer@1.0.0-beta.10/dist/resizable-drawer.min.css">
```
- **CDN - ES5:**
```
<script src="//npmcdn.com/resizable-drawer@1.0.0-beta.10/dist/resizable-drawer.es5.js"></script>`
<link rel="stylesheet" type="text/css" src="//npmcdn.com/resizable-drawer@1.0.0-beta.10/dist/resizable-drawer.min.css">
```
